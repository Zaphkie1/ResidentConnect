...
<body>
    <h1><i class="fa fa-rocket" style="color: #ffffff;">  </i> ResidentConnect <i class="fa fa-rocket" style="color: #ffffff;"></i></h1> <!-- Icono de nave espacial junto al título -->

    <div class="search-container">
        <div class="form">
            <input class="input" id="search" placeholder="Buscar" required="" type="text">
